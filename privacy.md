...
layout: default
title: Privacy
description: How Love, Ando handles your data, short version: barely any, and never sold.
---
...
- No cookies from us.
- No advertising or social-media trackers, no Facebook/Meta Pixel, no Google Ads tags, no session replay.
- No selling, renting, or trading your information, ever.
- No cross-site tracking or profiling.

If that ever changes, for example, if we add an advertising pixel down the road, we'll update this page and ask for consent where it's required.
...
Want your RSVP details removed, or have a question about your data? Email **andomccall@gmail.com** and we'll take care of it.
